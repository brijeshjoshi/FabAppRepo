...
namespace WebApplication1
{
    public partial class ATM : System.Web.UI.Page
    {
        ...
        {
            a.InsertATMData(Convert.ToInt32(ddlATM.SelectedValue), txtFaddress.Text, Convert.ToInt32(ddlCity.SelectedValue), Convert.ToInt32(ddlArea.SelectedValue));
            BindData();
            ClearData();
        }
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            a.UpdateATMData(Convert.ToInt32(txtID.Text), Convert.ToInt32(ddlATM.SelectedValue), txtFaddress.Text, Convert.ToInt32(ddlCity.SelectedValue), Convert.ToInt32(ddlArea.SelectedValue));
            BindData();
            ClearData();
        }
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            a.DeleteATMData(Convert.ToInt32(txtID.Text));
            BindData();
            ClearData();
        }
        ...
        protected void gvATM_ItemCommand(object sender, ListViewCommandEventArgs e)
        {
        ...
        protected void gvATM_SelectedIndexChanging(object sender, ListViewSelectEventArgs e)
        {
